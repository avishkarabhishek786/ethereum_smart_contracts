...
contract Sigs {
    ...
    function recoverAddr(address loggedInAccount, uint256 numberOfTokens, address tokenAddress, bytes memory signature) public pure returns(address) {
...
const signature = await web3.eth.sign(sha3hash, loggedInAccount);
